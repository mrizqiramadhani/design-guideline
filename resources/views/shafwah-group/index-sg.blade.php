  ...
  <body>
    ...
    <div class="w-full h-[800px] flex items-center justify-center bg-black">
      <div class="flex justify-center items-center space-x-0 w-full px-10 h-[400px] relative"> 
        <img src="{{ asset('img/paralax/Icon SG-05 (2).png') }}" alt="Icon SG-05" class="h-auto max-h-[130px] w-auto max-w-[20%] mb-10 -mr-9 -mt-6" /> 
        <img src="{{ asset('img/paralax/Logo Type SG-02 (1).png') }}" alt="Logo Type SG-02" class="h-auto max-h-[900px] w-auto max-w-[60%]" />
      </div>
    </div>
