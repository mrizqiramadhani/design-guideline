...
<body>
    ...
    <nav class="bg-white py-0 flex items-center justify-between">
        <div class="flex items-center">
            <a href="{{ route('shafwah-property') }}#downloads">
                <img src="{{ asset('img/main-SRP.png') }}" alt="Logo"
                    class="max-h-32 w-auto mr-4 m bg-white-200 mx-12 my-4 object-contain"></a>
        </div>
    </nav>
                        ...
                        <div class="relative">
                            ...
                            <div id="dropdownMenu-{{ $loop->index }}"
                                ...
                                <a href="{{ asset('storage/logo_photos/' . basename($photo->path)) }}"
                                    download="{{ $logo->title }}_logo_white_{{ $loop->iteration }}.jpg"
            ...
            @if ($photos->isEmpty())
                ...
                <div class="col-span-5 flex items-center justify-center h-full">
                    <div class="flex flex-col items-center text-center">
                        ...
                        <!-- Text -->
                        <p class="text-gray-600 font-medium">Sorry, no white photos available 😭</p>
                    </div>
                </div>
            @endif
        </div>
