    ...
    <div class="flex">
        ...
        <div class="flex-grow px-5 py-8 text-xl sm:text-2xl lg:px-10 lg:py-12">
            ...
            <div class="p-4 mb-8 min-h-[1000px]">
                ...
                <img src="{{ asset('img/filosofi-srp.png') }}" alt="Logo Shafwah Property"
            ...
            <div class="flex gap-4">
                <a href="https://shafwahgroup.com/id" class="hover:text-gray-400">
                    <svg 
                        ...
                        fill="white" 
                        class="fill-current">
                        <path d="M44.5 20H24v8.5h11.7C34.2 33.8 29.5 38 24 38c-7.2 0-13-5.8-13-13s5.8-13 13-13c3.1 0 6.1 1.1 8.4 3.2l6.3-6.3C34.5 5.4 29.5 3 24 3 11.8 3 2 12.8 2 25s9.8 22 22 22c11.3 0 20.7-8.2 21.9-19H44.5z"></path>
                    </svg>
                </a>
                <a href="https://www.instagram.com/shafwahgroup/#" class="hover:text-gray-400">
                    <svg 
                        ...
                        fill="white" 
                        class="fill-current">
                        <path d="M12 2.2c2.4 0 2.7.01 3.7.05 1.2.05 2 .24 2.6.5a5.4 5.4 0 0 1 2 1.3 5.4 5.4 0 0 1 1.3 2c.26.6.45 1.4.5 2.6.04 1 .05 1.3.05 3.7s-.01 2.7-.05 3.7c-.05 1.2-.24 2-.5 2.6a5.4 5.4 0 0 1-1.3 2 5.4 5.4 0 0 1-2 1.3c-.6.26-1.4.45-2.6.5-1 .04-1.3.05-3.7.05s-2.7-.01-3.7-.05c-1.2-.05-2-.24-2.6-.5a5.4 5.4 0 0 1-2-1.3 5.4 5.4 0 0 1-1.3-2c-.26-.6-.45-1.4-.5-2.6-.04-1-.05-1.3-.05-3.7s.01-2.7.05-3.7c.05-1.2.24-2 .5-2.6a5.4 5.4 0 0 1 1.3-2 5.4 5.4 0 0 1 2-1.3c.6-.26 1.4-.45 2.6-.5C9.3 2.2 9.6 2.2 12 2.2zm0-2.2C9.5 0 9.1 0 8.1.04 7.1.09 6.2.3 5.4.6a7.8 7.8 0 0 0-3 2A7.8 7.8 0 0 0 .6 5.4c-.3.8-.5 1.7-.6 2.7C0 9.1 0 9.5 0 12s0 2.9.04 3.9c.05 1 .3 1.9.6 2.7a7.8 7.8 0 0 0 2 3c.8.8 1.8 1.5 3 2 .8.3 1.7.5 2.7.6 1 .04 1.4.04 3.9.04s2.9 0 3.9-.04c1-.05 1.9-.3 2.7-.6a7.8 7.8 0 0 0 3-2 7.8 7.8 0 0 0 2-3c.3-.8.5-1.7.6-2.7.04-1 .04-1.4.04-3.9s0-2.9-.04-3.9c-.05-1-.3-1.9-.6-2.7a7.8 7.8 0 0 0-2-3 7.8 7.8 0 0 0-3-2c-.8-.3-1.7-.5-2.7-.6C14.9 0 14.5 0 12 0zm0 5.8a6.2 6.2 0 1 0 0 12.4 6.2 6.2 0 0 0 0-12.4zm0 10.2a4 4 0 1 1 0-8 4 4 0 0 1 0 8zm6.4-11a1.4 1.4 0 1 1 0-2.8 1.4 1.4 0 0 1 0 2.8z"></path>
                    </svg>
                </a>
            </div>
        </nav>
